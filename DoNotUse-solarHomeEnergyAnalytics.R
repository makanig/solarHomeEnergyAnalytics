...
dataDir = "H:/GoogleDriveSync/dataScience/pgeHomeUsage/pgeHomeUsageGitHub/data"
#dataDir = "data"
gasSkipLines = 5
...
actualDf$DATE = as.Date(format(date_decimal(actualDf$DATE),"%Y-%m-%d")) #generation df

lastSolarReading = last(actualDf$DATE)
...
# # inner join our combined data with weather data
# combinedData2 = combinedData %>% inner_join(weatherDf) 
# 
# (ggplot(combinedData2, aes(x = DATE)) +
#     geom_point(aes(y = energyProduced, colour = "energyProduced")) + 
#     geom_point(aes(y = dailyUsage, colour = "dailyUsage")) +
...
#     ggtitle("Solar generation, Energy Usage and Weather")) %>% ggplotly()
# 
# 
#     
#     plot_ly(combinedData2, x = ~DATE, y = ~energyProduced, type = 'scatter', mode = "markers",
#             name = 'SolarProduction',
#             marker = list(color = '#34b338'),
#             hoverinfo = "text",
#             text = ~paste(energyProduced, ' Kwh', DATE)) %>%
#       add_trace(y = ~dailyUsage,  type = 'scatter', mode = "markers", name = 'EnergyUsed', 
#                 marker = list(color = '#45171D'),
#                 hoverinfo = "text",
#                 text = ~paste(dailyUsage, 'Kwh', DATE)) %>%
#       layout(title = 'Solar generation, Energy Usage and Weather',
#              xaxis = list(title = ""),
#              yaxis = list(side = "left",  title = 'Energy in Kwh', showgrid = FALSE, zeroline = FALSE))
#     
#     
#  
#     plot_ly(combinedData2, x = ~DATE, y = ~energyProduced, type = "scatter",  mode = "markers",
#             name = 'SolarProduction',
#             marker = list(colour = "#34b338"),
#             hoverinfo = "text",
#             text = ~paste(energyProduced, " Kwh", DATE)) %>%
#       add_trace(y = ~dailyUsage,  type = "bar", name = "EnergyUsed",
#                 marker = list(colour = "#45171D"),
#                 hoverinfo = "text",
#                 text = ~paste(dailyUsage, 'Kwh', DATE)) %>%
#       layout(title = 'Solar generation, Energy Usage and Weather',
#              xaxis = list(title = ""),
#              yaxis = list(side = "left", overlaying = "y", title = 'Energy in Kwh', showgrid = FALSE, zeroline = FALSE))
#     
#     
#     
#     
...
#     #         hoverinfo = "text",
#     #         text = ~paste(energyProduced, ' Kwh', DATE)) %>%
#     #   add_trace(y = ~dailyUsage,  yaxis="y2", type = "scatter", mode = "markers", name = "EnergyUsed", 
#     #             marker = list(color = '#45171D'),
#     #             hoverinfo = "text",
#     #             text = ~paste(dailyUsage, 'Kwh', DATE)) %>%
#     #   layout(title = "Solar generation, Energy Usage and Weather",
...
#             name = "SolarProduction",
#             yaxis="y1",
#             #line = list(shape="spline", dash="dash", color = "#34b338"),
#             marker = list(colour = "#34b338"),
#             hoverinfo = "text",
#             text = ~paste(energyProduced, ' Kwh', DATE)) %>%
#       add_trace(y = ~dailyUsage,  type = "bar",  name = "EnergyUsed", 
...
#                 hoverinfo = "text",
#                 text = ~paste(dailyUsage, "Kwh", DATE)) %>%
#       add_lines(x = ~DATE, y = ~TEMP, type = "scatter", mode = "lines", name = "Temp", 
#                 yaxis = "y2",
#                 #line = list(shape="spline", dash="dash"),
#                 #marker = list(color = '#e60926', symbol="dash"),
#                 line = list(shape="spline", dash="dash", color = "#e60926"),
#                 hoverinfo = "text",
#                 text = ~paste(TEMP, "(", TMAX,"High,",TMIN,"Low)oF", DATE)) %>%
#       layout(title = "Solar generation, Energy Usage and Weather",
#              xaxis = list(title = ""),
#              yaxis = list(side = "left",  title = "Energy in Kwh", 
#                           showgrid = FALSE, zeroline = FALSE),
...
#             text = ~paste(dailyUsage, "Kwh", DATE)) %>%
#   
#       add_trace(y = ~energyProduced, type = "scatter", mode="markers",
#             name = "SolarProduction",
#             yaxis="y1",
#             #line = list(shape="spline", dash="dash", color = "#34b338"),
#             #marker = list(colour = I("#34b338")),
#             hoverinfo = "text",
#             text = ~paste(energyProduced, " Kwh", DATE)) %>%
#       add_trace(x = ~DATE, y = ~TEMP, type = "scatter", mode = "markers",   name = "Temp", 
#                 yaxis = "y2",
#                 #line = list(shape="spline", dash="dash"),
#                 #= list(color = '#e60926', symbol="dash"),
#                 #line = list(shape="loess", dash="dash", color = "#e60926"),
#                 marker = list(colour = "#e60926"),
#                 hoverinfo = "text",
#                 text = ~paste(TEMP, "(", TMAX,"High,",TMIN,"Low)F", DATE)) %>%
#       layout(title = "Solar generation, Energy Usage and Weather",
#              xaxis = list(title = ""),
#              yaxis = list(side = "left",  title = "Energy in Kwh", 
#                           showgrid = FALSE, zeroline = FALSE),
...
#             hoverinfo = "text",
#             text = ~paste(energyProduced, ' Kwh', DATE)) %>%
#       add_trace(y = ~dailyUsage,  type = "bar",  name = "EnergyUsed",colour = "#45171D",
#                 yaxis="y1",
#                 hoverinfo = "text",
#                 marker = list( colour = "#45171D"),
#                 text = ~paste(dailyUsage, "Kwh", DATE)) %>%
#       add_trace(x = ~DATE, y = ~TMAX, type = "scatter", mode = "markers", name = "Max temp", 
#                 yaxis = "y2",
#                 # line = list(shape="spline", dash="dash"),
#                 marker = list(color = '#e60926', symbol="diamond"),
#                 #line = list(shape="spline", dash="dash", color = "#e60926"),
#                 hoverinfo = "text",
#                 text = ~paste(TMAX, "°F", DATE)) %>%
#       layout(title = "Solar generation, Energy Usage and Weather",
#              xaxis = list(title = ""),
#              yaxis = list(side = "left",  title = "Energy in Kwh", 
#                           showgrid = FALSE, zeroline = FALSE),
...
#                            showgrid = FALSE, zeroline = FALSE))
#     
#     c3 = replace(combinedData2, TRUE, lapply(combinedData2, NA2mean))
#     
#     
#     plot_ly(c3, x = ~DATE, y = ~energyProduced, type = "scatter", mode="markers",
#             name = "SolarProduction",
#             yaxis="y1",
#             #line = list(shape="spline", dash="dash", color = "#34b338"),
#             #marker = list(color = "#34b338"),
...
#                 marker = list( colour = "#45171D"),
#                 text = ~paste(dailyUsage, "Kwh", DATE)) %>%
#       add_lines(x = ~DATE, y = ~fitted(loess(TMAX ~ as.numeric(DATE), span=0.2)),
...
#   
#     
#     # myDf <- data.frame(MediaDate = as.Date(c("2016-04-01","2016-05-01","2016-06-01"), 
#     #                                      format = "%Y-%m-%d"),
...
#     # myDf = tbl_df(myDf)
#     # 
#     # plot_ly(myDf, x = ~MediaDate, y = ~Spend, yaxis = "y1", type = "bar", name = "Spend") %>%
